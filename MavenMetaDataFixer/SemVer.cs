...
namespace NuGet
{
    ...
    public sealed class SemanticVersion : IComparable, IComparable<SemanticVersion>, IEquatable<SemanticVersion>
    {
        ...
        public static SemanticVersion Parse(string version)
        {
            ...
            {
                throw new ArgumentException(String.Format(CultureInfo.CurrentCulture, "Invalid Version", version), "version");
            }
            return semVer;
        }
        ...
        public int CompareTo(object obj)
        {
            ...
            if (other == null)
            {
                throw new ArgumentException("Type must be semantic version", "obj");
            }
